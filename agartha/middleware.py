...
Configure via `Agartha(middleware=[...])`.
"""
import inspect
import re
from collections.abc import Awaitable, Callable

from agartha.llm.contracts import LLMRequest, LLMResponse, ToolCall
...
class GroundingGuard(Middleware):
    ...
    (e.g. an LLM judge); it may be sync or async:
        ...
        Agartha(middleware=[GroundingGuard(chunks, verifier=judge)])
    """
