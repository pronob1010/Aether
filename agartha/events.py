...
by `Agartha` — request start/complete/error, stream chunks, tool dispatch.
...
from agartha.llm.contracts import LLMRequest, LLMResponse, LLMStreamChunk, ToolCall
...
class EventBus:
    ...
    Pass an instance to multiple `Agartha` clients if you want them to share
